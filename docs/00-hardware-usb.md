...
See the manufacturer's [A520M K/K V2 manual, page 12](https://download.gigabyte.com/FileList/Manual/mb_manual_a520m-k-series_e_1101.pdf)
for the rear-panel diagram. It is linked rather than copied into this repository.
The physical layout is the addressing scheme here: "the USB3 port" means four
sockets in two separated pairs, and `find-port.sh`/`ID_PATH` did not distinguish
the tested sockets.
