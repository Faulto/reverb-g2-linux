...
Presence device serial / InstanceId:
    03f0:0580, serial <redacted-g2-serial>
    HID\VID_03F0&PID_0580\<redacted-instance-suffix>  (child collection, stable across reconnects)
Sensors device serial / InstanceId:
    045e:0659, serial <redacted-sensor-serial>
