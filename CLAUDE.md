...
the patch, and the NVIDIA report submitted upstream; the raw `nvidia-bug-report.log.gz`
is intentionally not redistributed because it contains host metadata). There's also text ready to open the issue
